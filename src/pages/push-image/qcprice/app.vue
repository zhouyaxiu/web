            ...
            <div class="taskInfo">
              ...
              <div class="taskInfos">
                  ...
                  <el-col :span="8">
                    <el-form-item prop="num">
                      <el-row :gutter="20">
                        ...
                        <el-col :span="5" >{{$t("pushimage.qcprice.zhang")}}</el-col>
                      </el-row>
                    </el-form-item>
                  </el-col>
                </el-form-item>
                ...
                <el-form-item :label="$t('pushimage.qcprice.estimate')" prop="taskTime">
                  <el-row :gutter="20">
                    ...
                    <el-col :span="6">{{$t("pushimage.qcprice.minute")}}</el-col>
                  </el-row>
                </el-form-item>
              </div>
              <div class="taskTit">
              ...
              <div class="taskInfos">
                ...
                <div class="spot-check" v-if = "paramForm.checkType === 1">
                  <el-form-item :label="$t('pushimage.qcprice.priceratio')" prop="checkProportion">
                    <el-row :gutter="20">
                      <el-col :span="6" style="padding-left:0"><el-input v-model.number="paramForm.checkProportion"></el-input></el-col>
                      <el-col :span="16">%{{$t("pushimage.qcprice.scale")}}</el-col>
                    </el-row>
                  </el-form-item>
                  ...
                  <p class="fh-prompt">{{$t("pushimage.qcprice.spotnumber")}}{{$t("pushimage.qcprice.leftpart")}}{{checkNumber}}{{$t("pushimage.qcprice.zhang")}}{{$t("pushimage.qcprice.rightpart")}}{{$t("pushimage.qcprice.taskprice")}}{{$t("pushimage.qcprice.leftpart")}}{{checkMoney}}{{$t("pushimage.qcprice.integral")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                </div>
                <div class="all-check" v-if = "paramForm.checkType === 2">
                  ...
                  <el-form-item :label="$t('pushimage.qcprice.checktimes')" prop="allCheckNum">
                    <el-row :gutter="20">
                      ...
                      <el-col :span="16">{{$t("pushimage.qcprice.time")}}</el-col>
                    </el-row>
                  </el-form-item>
                  <p class="fh-prompt">{{$t("pushimage.qcprice.checknumber")}}{{$t("pushimage.qcprice.leftpart")}}{{allCheckNum}}{{$t("pushimage.qcprice.zhang")}}{{$t("pushimage.qcprice.rightpart")}}{{$t("pushimage.qcprice.taskprice")}}{{$t("pushimage.qcprice.leftpart")}}{{checkMoney}}{{$t("pushimage.qcprice.integral")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                </div>
                <div class="right-answer" v-if = "paramForm.checkType === 3">
                  <el-form-item :label="$t('pushimage.qcprice.total')" prop="rightAnswer">
                    <el-row :gutter="20">
                      ...
                      <el-col :span="16">{{$t("pushimage.qcprice.perzhang")}}</el-col>
                    </el-row>
                  </el-form-item>
                  <el-form-item :label="$t('pushimage.qcprice.labelnum')" prop="tagNumber">
                    <el-row :gutter="20">
                      ...
                      <el-col :span="16">{{$t("pushimage.qcprice.moreamount")}}</el-col>
                    </el-row>
                  </el-form-item>
                  <p class="fh-prompt">{{$t("pushimage.qcprice.leastlabel")}}{{$t("pushimage.qcprice.leftpart")}}{{accDoMinNum}}{{$t("pushimage.qcprice.zhang")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                  <p class="fh-prompt">{{$t("pushimage.qcprice.morelabel")}}{{$t("pushimage.qcprice.leftpart")}}{{accDoMaxNum}}{{$t("pushimage.qcprice.zhang")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                </div>
                <div class="gold-test" v-if = "paramForm.checkType === 4">
                  ...
                  <p class="fh-prompt">{{$t("pushimage.qcprice.expectlabel")}}{{$t("pushimage.qcprice.leftpart")}}{{goldHitDoNum}}{{$t("pushimage.qcprice.zhang")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                </div>
              </div>
              <div class="taskTit">
              ...
              <div class="taskInfos">
                ...
                <p class="fh-prompt">{{$t("pushimage.qcprice.suggestprice")}}{{$t("pushimage.qcprice.leftpart")}}{{this.suggestOffer}}{{$t("pushimage.qcprice.integral")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                <p class="fh-prompt">{{$t("pushimage.qcprice.leastprice")}}{{$t("pushimage.qcprice.leftpart")}}{{this.minOffer}}{{$t("pushimage.qcprice.integral")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                <el-form-item :label="$t('pushimage.qcprice.unitprice')" prop="offer">
                  <el-row :gutter="20">
                    ...
                    <el-col :span="6">{{$t("pushimage.qcprice.integral")}}</el-col>
                  </el-row>
                </el-form-item>
                <p class="fh-prompt fh-sum" v-show = "checkSum !== 0">{{$t("pushimage.qcprice.totalprice")}}{{$t("pushimage.qcprice.leftpart")}}{{checkSum}}{{$t("pushimage.qcprice.inter")}}{{$t("pushimage.qcprice.rightpart")}}</p>
                <p class="fh-prompt fh-sum">{{$t("pushimage.qcprice.sumprice")}}【{{sum}}{{$t("pushimage.qcprice.inter")}}】</p>
              </div>
            </div>
          </el-col>
        </el-row>
        ...
        axios
          ...
          .then(function (response) {
            ...
            if (rsp.code === 0) {
              ...
              // 延时500ms跳转
              if (forword) {
                util.Redirect('/push-project-sample/image/' + vm.projectid, 1000)
              }
            } else {
              vm.$notify.error({
                title: language('pushTask.js.error'),
