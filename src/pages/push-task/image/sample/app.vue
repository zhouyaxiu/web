  <template>
   <div id="main" class="main push-task">
    ...
    <Layout :selStep="3" :active="3" :type="'image'" :projectId="projectId" style="flex:1">
        <div class="d-flex justify-content-between mb-3">
           <p class="h4 text-secondary">{{$t("pushimage.sample.trueexample")}}</p>
        ...
        <div class="d-flex justify-content-between mb-3">
          <p class="h4 text-secondary">{{$t("pushimage.sample.errorexample")}}</p>
