  <template>
   <div id="main" class="main push-task">
    ...
    <Layout :selStep="3" :active="3" :type="'wav'" :projectId="projectId" style="flex:1">
      <div class="mb-5">
        <div class="d-flex justify-content-between mb-3">
          <p class="h4 text-secondary">{{$t("pushWav.sample.trueExample")}}</p>
       ...
       <div class="mb-5">
         <div class="d-flex justify-content-between mb-3">
          <p class="h4 text-secondary">{{$t("pushWav.sample.falseExample")}}</p>
