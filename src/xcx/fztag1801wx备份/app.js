...
var wxApiInterceptors = require("utils/wxApiInterceptors.js");
...
App({
  onLaunch: function () {
    event.on('sendTime', this, newTime => {
      newTime=newTime||0
      time = Date.now()-newTime || 3000
      // this.setData({
      //   time: newTime
      // })
      console.log(newTime,'timetimetime')
